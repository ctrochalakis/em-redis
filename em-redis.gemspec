...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "History.txt", "README.rdoc", "Rakefile", "lib/em-redis.rb", "lib/em-redis/redis_protocol.rb", "spec/live_redis_protocol_spec.rb", "spec/redis_commands_spec.rb", "spec/redis_protocol_spec.rb", "spec/test_helper.rb"]
